...
class AddViewController: UIViewController, UITextFieldDelegate
{
    ...
    @IBAction func layertTopValidation(sender: UITextField) {
    ...
    override func viewWillAppear(animated: Bool) {
        ...
        if(!allrecords.isEmpty){
            ...
            let sendButton = UIBarButtonItem(title: "Save", style: UIBarButtonItemStyle.Plain, target: self, action: "saveData")
